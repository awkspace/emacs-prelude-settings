...
(defvar sourcepawn-mode-font-lock-regexp-variable-names-prefix
  "\\(?:new\\|decl\\|int\\|float\\|bool\\|char\\|void\\)[ \t]+"
...
(defvar sourcepawn-mode-font-lock-regexp-keywords
  "\\<\\(assert\\|b\\(?:egin\\|ool\\|reak\\)\\|c\\(?:ase\\|ellsof\\|hars?\\|on\\(?:st\\|tinue\\)\\)\\|d\\(?:e\\(?:cl\\|fault\\|lete\\)\\|o\\)\\|e\\(?:lse\\|num\\|xit\\)\\|f\\(?:loat\\|or\\(?:ward\\)?\\|unc\\(?:enum\\|tag\\)\\)\\|i\\(?:f\\|nt\\)\\|n\\(?:ative\\|ew\\)\\|operator\\|public\\|return\\|s\\(?:izeof\\|t\\(?:atic\\|ock\\|ruct\\)\\|witch\\)\\|tagof\\|void\\|while\\)\\>"
